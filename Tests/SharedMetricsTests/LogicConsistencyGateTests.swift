...
@Test func widgetCompactSnapshotPreservesWidgetFallbackVisibleFields() {
    ...
    #expect(compact.memoryUsedBytes == 8_000)
    #expect(compact.memoryTotalBytes == 16_000)
    ...
    #expect(compact.batteryPercent == 0.62)
    #expect(compact.batteryPowerSource == "Battery Power")
